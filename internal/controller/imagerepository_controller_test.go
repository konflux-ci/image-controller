...
var _ = Describe("Image repository controller", func() {
	...
	Context("Image repository for component provision", func() {
		...
		assertProvisionRepository := func(updateComponentAnnotation, grantRepoPermission, checkNamespaceSecret bool) {
			...
			namespaceSecretName := getNamespacePullSecretName(defaultNamespace)
		...
		It("should provision image repository for component, with update component annotation, update also namespace secret", func() {
			namespaceSecretKey := types.NamespacedName{Name: getNamespacePullSecretName(defaultNamespace), Namespace: defaultNamespace}
